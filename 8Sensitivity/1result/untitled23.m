...
% 加载数据
%参考点
b0=a(1,4)-a(1,2),c0=a(1,4)-a(1,3);
b=a(2:1:25,4)-a(2:1:25,2);
c=a(2:1:25,4)-a(2:1:25,3);
...
% 绘制柱状图
bar(X_numeric - offset, b_change, barWidth, 'FaceColor', [0.43, 0.33, 0.99]); % 蓝色柱状图
hold on
bar(X_numeric + offset, c_change, barWidth, 'FaceColor', 'green'); % 红色柱状图
...
legend('S_{2}','S_{3}',  'FontSize', 17) % 添加图例，设置字体大小为20