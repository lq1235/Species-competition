...
for g=1:b
    ...
    for k=1:2000
        ...
        t=0;
        i=1;
        t0=80;%之前用的这个计算的比较好，总共计算了1000次，计算100次的效果也是非常不错，计算50次的效果也不错
        steps=t0/dt;
        %初始条件
        N1=99;N2=0;N3=0;
        while t<=t0
...
hold on
% plot([9.9 9.9],[1.595659438497883,4.430157038497884],'r--','LineWidth',1)
% axis([7.37408018050976,18.003446180509766,1.595659438497883,4.430157038497884])
title('N1')
xlabel('S_{3}','FontSize',27)
...
hold on
% plot([9.9 9.9],[1.130095686480076,3.706911686480075],'r--','LineWidth',1)
% axis([8.079243076279422,17.742303076279423,1.130095686480076,3.706911686480075])
title('N2')
set(gca,'LineWidth',1.2,'Fontsize',27)
set(gca,'TickDir', 'in', 'TickLength', [0.009 0.01])
xlabel('S_{3}','FontSize',27)
...
hold on
% plot([9.9 9.9],[0.852946091519959,3.581150031519961],'r--','LineWidth',1)
% axis([6.98541627245365,18.67771887245366,0.852946091519959,3.581150031519961])
title('N3')
set(gca,'LineWidth',1.2,'Fontsize',27)
set(gca,'TickDir', 'in', 'TickLength', [0.009 0.01])
xlabel('S_{3}','FontSize',27)
...
% plot([9.9 9.9],[-0.003363815687979,0.074584868312021],'r--','LineWidth',1)
% axis([7.374141822042939,19.06644442204296,-0.003363815687979,0.074584868312021])
set(gca,'LineWidth',1.2,'Fontsize',27)
set(gca,'TickDir', 'in', 'TickLength', [0.009 0.01])
title('N1-N2')
% set(gca,'LineWidth',1.2,'Fontsize',27)
...
hold on
% plot([9.9 9.9],[-0.003363815687979,0.074584868312021],'r--','LineWidth',1)
% axis([8.568955531324695,17.353555531324695,0.02765243550633,0.03643703550633])
set(gca,'LineWidth',1.2,'Fontsize',27)
set(gca,'TickDir', 'in', 'TickLength', [0.009 0.01])
title('N1-N3')
% set(gca,'LineWidth',1.2,'Fontsize',27)
...
hold on
% plot([9.9 9.9],[0.001804662262532,0.014688742262532],'r--','LineWidth',1)
% axis([8.099217212757912,17.762277212757912,0.001804662262532,0.014688742262532])
set(gca,'LineWidth',1.2,'Fontsize',27)
set(gca,'TickDir', 'in', 'TickLength', [0.009 0.01])
...
%保存数据
filename1 = ['data_S_{3}=', num2str(10, '%.3f'), '--S_{3}=', num2str(16, '%.3f'), '.mat'];
save(filename1);
