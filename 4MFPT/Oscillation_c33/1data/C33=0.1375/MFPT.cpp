...
{	
	...
	// a1=0.056+ (filenum-1.0)*0.0005;
		a1=0.1375;                                       
	       	...
	       	x2[0] = 25.0068;x2[1] = 45.7524;x2[2] = 39.9166;//  初始态 
	       	
	       	x1[0] = 26.4344;x1[1] = 41.8033; x1[2] = 42.0765;  //  末了态 
	...
	****/	
		...
		fprintf(fp1, "%0.5f	%f	%f	%f	%f	%f	%f	%f	%f\n", a1, tau, var_t, xi[0], xi[1], xi[2], xf[0],xf[1], xf[2]);
	}                                                                                                                               
	fclose(fp1);
	fclose(fp2);
}
