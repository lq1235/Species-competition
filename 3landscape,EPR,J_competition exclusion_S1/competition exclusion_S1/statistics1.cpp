...
{  
	...
	double x_min[Dim]={0,0,0},x_max[Dim]={150,120,120};;  
...
for(filenum=1;filenum<45;filenum++)
	{
		
	 a1=3.6+ (filenum-1.0)*0.1;
	  //a1 =4.35;
...
***********/
	...
	for(iter=1.0;iter<=Tnf;iter=iter+1)                                      
	{
       ...
       /************         
		...
		sprintf(st2,"pp%d%d_%s_%0.6f.txt",index1,index2,a_1,a1);
