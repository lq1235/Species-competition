...
[X,Y] = meshgrid(x,y);
file_path = 'pp%d%d_C11_%0.6fXm80.0.txt';
for j = 1:num
...
set(gca,'xtick',0.0550:0.001:0.0615)

ylim([-55.76228473495291,343.5377152650472])

% xlabel('\fontsize{27} C_{15}');
% ylabel('\fontsize{27} EPR');
% 0.0560:0.0005:0.0605
% set(gca,'xtick',0.0560:0.001:0.0605)
% set(gca,'LineWidth',1.2,'Fontsize',27)
% set(gca,'TickDir', 'in', 'TickLength', [0.009 0.01])
...
%
xlim([0.055173484275628,0.061162984275628])
ylim([-0.089772720923666,1.386236685474499])
set(gca,'xtick',0.0550:0.001:0.0615)
set(gca,'LineWidth',1.2,'Fontsize',27)
set(gca,'TickDir', 'in', 'TickLength', [0.009 0.01])
