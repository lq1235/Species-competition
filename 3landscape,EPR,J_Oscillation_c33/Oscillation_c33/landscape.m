...
file_path = 'pp12_C33_0.12500Xm80.0.txt';
...
quiver(X(mg,ng),Y(mg,ng),FFx(mg,ng),FFy(mg,ng),0.35,'color','k','LineWidth',1);
hold on
quiver(X(mg,ng),Y(mg,ng),JJx(mg,ng),JJy(mg,ng),0.5,'color','W','LineWidth',1);
% set(gca,'XTickLabelRotation',90);%46是字体的旋转角度
% set(gca,'YTickLabelRotation',90);%46是字体的旋转角度
